...
- **FEAT-13 — Lightbox na zdjęciach (jacht + przyszła galeria „Program rejsu").** Zdjęcia w sekcji jacht i w galerii programu rejsu powiększają się po kliknięciu do formy galerii. *(Michał email 07-23 #1-2)*
