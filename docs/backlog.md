...
- **FEAT-8 — Badge „BRAK MIEJSC"** gdy odcinek/rejs wyprzedany (wyraźny napis że jest, ale sprzedany). *(Michał 07-07 #1)* **Rozszerzenie (Tomek 07-24):** przy wyborze segmentów badge/mini-baner „Wyprzedane" (wyraźnie odróżniający się) + gdy mało miejsc, licznik np. „Wolne 3 miejsca". Derive z zajętości koi segmentu (nie storage).
