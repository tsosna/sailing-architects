// Wspólny moduł treści Q&A dla landing FAQ + strony /poradnik.
// Źródło redakcyjne: docs/design/design_handoff_sailing_architects_new_qa/components/crew-guide.js

export type CrewGuideCategoryId =
	| 'przed-rejsem'
	| 'kto-plynie'
	| 'zycie-na-pokladzie'
	| 'bezpieczenstwo'
...
export type CrewGuideChecklistId = 'dokumenty' | 'pakowanie' | 'platnosci'

export type CrewGuideCategory = {
	id: CrewGuideCategoryId
	label: string
	icon: string
}

export type CrewGuideChecklist = {
	id: CrewGuideChecklistId
	title: string
	phase: string
	items: ReadonlyArray<string>
}

export type CrewGuideQuestion = {
	id: string
	category: CrewGuideCategoryId
	phase: string
	q: string
	a: string
	featured?: boolean
...
export const crewGuideCategories: ReadonlyArray<CrewGuideCategory> = [
...
export const crewGuideChecklists: ReadonlyArray<CrewGuideChecklist> = [
	{
		id: 'dokumenty',
		title: 'Dokumenty',
...
export const crewGuideQuestions: ReadonlyArray<CrewGuideQuestion> = [
	{
		id: 'q1',
		category: 'przed-rejsem',
		featured: true,
	...
	},
	{
		...
		a: 'Składka pokładowa jest zbierana od całej załogi (bez skippera) i pokrywa wspólne zakupy spożywcze, opłaty portowe i paliwo. Jeżeli po rejsie zostaje niewykorzystana część — dzielimy ją i zwracamy załodze. Średnio na 7-dniowy rejs to 150–200 EUR/osobę.'
	},
	{
		id: 'q25',
		category: 'logistyka',
...
export const featuredCrewGuideQuestions: ReadonlyArray<CrewGuideQuestion> =
	crewGuideQuestions.filter((item) => item.featured === true)
